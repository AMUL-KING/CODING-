...
[\x1b[1;97m•\33[1;97m] Autor  : AMUL-Xd \n[\x1b[1;97m•\33[1;97m] Github : AMUL-Xd\x1b[1;97m\n---------------------------------------------------------------------""")
		...
		print('          %s[ %sWelcome To AMUL-Xd Tool %s%s ]\n'%(N,O,N,O))
...
class Assets(Main):
	...
	def validate(self):
		...
		exit(
			...
			" [program finished] crack finished, AMUL-Xd"
